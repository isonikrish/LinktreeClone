        ...
        <ul>
          <Link href="/admin">
            <li
              ...
              className={`flex items-center space-x-3 py-4 my-4 rounded-2xl px-2 cursor-pointer transition duration-200 ${activeMenu === '/admin'
          ...
          <Link href="/admin/appearance">
            <li
              ...
              className={`flex items-center space-x-3 py-4 my-4 rounded-2xl px-2 cursor-pointer transition duration-200 ${activeMenu === '/admin/appearance'
                  ? 'text-[#8129D9] bg-[#F3F3F1]'
                  : 'text-gray-700 hover:text-[#8129D9] hover:bg-[#F3F3F1]'
                }`}
            >
          ...
          <Link href="/admin/analytics">
            <li
              ...
              className={`flex items-center space-x-3 py-4 my-4 rounded-2xl px-2 cursor-pointer transition duration-200 ${activeMenu === '/admin/analytics'
                  ? 'text-[#8129D9] bg-[#F3F3F1]'
                  : 'text-gray-700 hover:text-[#8129D9] hover:bg-[#F3F3F1]'
                }`}
            >
